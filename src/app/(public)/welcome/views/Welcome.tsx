...
export default function Welcome() {
  return (
    <div className="box-border flex min-h-screen w-screen max-w-2xl snap-center flex-col items-center justify-center place-self-center">
      <h1 className="text-center text-6xl font-bold">Welcome</h1>
      <h2 className="text-center text-2xl font-bold"> to the </h2>
      <h1 className="text-center text-8xl font-bold">Pocket Bar Book</h1>
      <p className="my-4">

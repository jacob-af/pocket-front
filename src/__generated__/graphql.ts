...
export type LoginMutation = {
  ...
  login: {
    ...
    accessToken: string;
    refreshToken: string;
    user: { __typename?: "User"; id: string; userName: string; email: any };
  };
};
...
export type SignupMutation = {
  ...
  signup: {
    ...
    accessToken: string;
    refreshToken: string;
    user: { __typename?: "User"; email: any; id: string; userName: string };
  };
};
...
export type UserBuildsQuery = {
  ...
  usersBuilds?: Array<{
    ...
    recipe: { __typename?: "Recipe"; name: string; about?: string | null };
    touch: Array<{
      __typename?: "Touch";
      id: string;
      amount?: number | null;
...
export type AllUsersQuery = {
  __typename?: "Query";
  allUsers: Array<{ __typename?: "User"; id: string; userName: string } | null>;
};

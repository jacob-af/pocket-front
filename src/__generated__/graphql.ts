...
export type LogOutMutation = {
  __typename?: "Mutation";
  logout: { __typename?: "LogoutResponse"; loggedOut: boolean };
};

export type CreateManyIngredientsMutationVariables = Exact<{
  createManyIngredientInputs:
    | Array<InputMaybe<CreateIngredientInput>>
    | InputMaybe<CreateIngredientInput>;
}>;

export type CreateManyIngredientsMutation = {
  __typename?: "Mutation";
...
export type AddBuildMutation = {
  ...
  createBuild?: {
    ...
    recipe: { __typename?: "Recipe"; name: string };
    touch: Array<{
      __typename?: "Touch";
      amount?: number | null;
      order?: number | null;
...
export type ChangeBuildPermissionMutation = {
  __typename?: "Mutation";
  changeBuildPermission?: {
    __typename?: "BuildPermissionResponse";
    status?: { __typename?: "StatusMessage"; message?: string | null } | null;
  } | null;
};
...
export type RemoveBuildPermissionMutation = {
  __typename?: "Mutation";
...
export type FollowMutation = {
  __typename?: "Mutation";
  followUser?: { __typename?: "StatusMessage"; message?: string | null } | null;
};
...
export type RecipeListQuery = {
  __typename?: "Query";
  recipeList: Array<{ __typename?: "Recipe"; id: string; name: string } | null>;
  ingredients: Array<{
    __typename?: "Ingredient";
    id: string;
    name: string;
...
export type FindFolloweddUsersBuildPermissionQuery = {
  __typename?: "Query";
  findFolloweddUsersBuildPermission?: Array<{
    __typename?: "UserBuildPermission";
...
} as unknown as DocumentNode<GetTokensMutation, GetTokensMutationVariables>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "loggedOut" } }
              ]
            }
          }
        ]
...
export const CreateManyIngredientsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateManyIngredients" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "createManyIngredientInputs" }
          },
          type: {
            kind: "NonNullType",
            type: {
              ...
              type: {
                kind: "NamedType",
                name: { kind: "Name", value: "CreateIngredientInput" }
              }
            }
          }
        }
  ...
  CreateManyIngredientsMutation,
  CreateManyIngredientsMutationVariables
>;
                ...
                { kind: "Field", name: { kind: "Name", value: "createdAt" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "ice" } }
                    ]
                  }
                }
              ]
...
>;
export const AddBuildDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "AddBuild" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "createBuildInput" }
          },
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "CreateBuildInput" }
...
} as unknown as DocumentNode<AddBuildMutation, AddBuildMutationVariables>;
export const ChangeBuildPermissionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "ChangeBuildPermission" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "changeBuildPermissionInput" }
          },
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "ChangeBuildPermissionInput" }
  ...
  ChangeBuildPermissionMutation,
  ChangeBuildPermissionMutationVariables
>;
export const RemoveBuildPermissionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "RemoveBuildPermission" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "deleteBuildPermission" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "changeBuildPermissionInput" },
  ...
  RemoveBuildPermissionMutation,
  RemoveBuildPermissionMutationVariables
>;
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "unfollowId" }
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "String" } }
...
} as unknown as DocumentNode<IngredientsQuery, IngredientsQueryVariables>;
export const UserBuildsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "userBuilds" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "usersBuilds" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "buildName" } },
                { kind: "Field", name: { kind: "Name", value: "glassware" } },
                { kind: "Field", name: { kind: "Name", value: "ice" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "instructions" }
...
} as unknown as DocumentNode<UserBuildsQuery, UserBuildsQueryVariables>;
export const RecipeListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "RecipeList" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<RecipeListQuery, RecipeListQueryVariables>;
export const FindFolloweddUsersBuildPermissionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  FindFolloweddUsersBuildPermissionQuery,
  FindFolloweddUsersBuildPermissionQueryVariables
>;
...
export const AllRelationsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "allRelations" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "findFollows" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "userName" } },
...
} as unknown as DocumentNode<AllRelationsQuery, AllRelationsQueryVariables>;

...
export type UserBuildsQuery = { __typename?: 'Query', usersBuilds?: Array<{ __typename?: 'Build', buildName: string, glassware?: string | null, ice?: string | null, instructions?: string | null, recipe: { __typename?: 'Recipe', name: string, about?: string | null }, touch: Array<{ __typename?: 'Touch', id: string, amount?: number | null, unit?: string | null, order?: number | null, ingredient?: { __typename?: 'Ingredient', id: string, name: string, description: string } | null } | null> } | null> | null };
